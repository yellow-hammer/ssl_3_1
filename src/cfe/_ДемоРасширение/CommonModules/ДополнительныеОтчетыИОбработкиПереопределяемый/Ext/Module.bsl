...
Процедура _ДемоОпределитьРазделыСДополнительнымиОбработками(Разделы) Экспорт
	Разделы.Добавить(Метаданные.Подсистемы._ДемоРасширение);
КонецПроцедуры
...
Процедура _ДемоОпределитьРазделыСДополнительнымиОтчетами(Разделы) Экспорт
	Разделы.Добавить(Метаданные.Подсистемы._ДемоРасширение);
КонецПроцедуры
