...
Функция ЗначениеПоИмени(ИмяЗначения) Экспорт
    ...
    ИначеЕсли ИмяЗначения = "ext_administrator" Тогда
        Возврат ПредопределенноеЗначение("Перечисление.РолиПользователейАбонентов.АдминистраторСредствАдаптации");
    Иначе
...
Функция ИмяПоЗначению(Значение) Экспорт
    ...
    ИначеЕсли Значение = ПредопределенноеЗначение("Перечисление.РолиПользователейАбонентов.ПользовательАбонента") Тогда
        Возврат "user";
    ИначеЕсли Значение = ПредопределенноеЗначение("Перечисление.РолиПользователейАбонентов.АдминистраторСредствАдаптации") Тогда
        Возврат "ext_administrator";
    Иначе 
