...
Процедура ЗаполнитьСписокВыбораВидовДокумента()
	...
	КонецЦикла;
  	...
  	Идентификаторы = ОбщегоНазначения.ИдентификаторыОбъектовМетаданных(ИменаДокументов);
  
	Для Каждого Идентификатор Из Идентификаторы Цикл	
		Отбор = Новый Структура("Представление", Идентификатор.Значение.Синоним);
		НайденныеСтроки = ТаблицаВидов.НайтиСтроки(Отбор);
		Если НайденныеСтроки.Количество()= 0 Тогда
			НоваяСтрока = ТаблицаВидов.Добавить();
			НоваяСтрока.ВидДокумента = Идентификатор.Значение.Ссылка;
			НоваяСтрока.Представление = Идентификатор.Значение.Синоним;
